...
training = pd.read_csv(r"D:\Study\Development\Web_Development\JS_CWH\MVault\Training.csv")
testing = pd.read_csv(r"D:\Study\Development\Web_Development\JS_CWH\MVault\Testing.csv")
...
def getDescription():
    ...
    with open('D:\\Study\\Development\\Web_Development\\JS_CWH\\MVault\\symptom_Description.csv')as csv_file:
...
def getSeverityDict():
    ...
    with open("D:\\Study\\Development\\Web_Development\\JS_CWH\\MVault\\Symptom_severity.csv")as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        line_count = 0
        try:
            for row in csv_reader:
...
def getPreCautionDict():
    ...
    with open ('D:\\Study\\Development\\Web_Development\\JS_CWH\\MVault\\symptom_precaution.csv')as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        line_count = 0
        for row in csv_reader:
...
def sec_predict(symptoms_exp):
    df = pd.read_csv(r'D:\Study\Development\Web_Development\JS_CWH\MVault\Training.csv')
    X = df.iloc[:, :-1].copy()
    y = df['prognosis']
